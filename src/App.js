      ...
      <div className="app3">
        <div className="row">
              ...
              <div className="col-md-9 offset-md-2">Start by stating your level of proficiency with each technology (e.g. "Proficient in HTML and CSS, and experienced with React").
               ...
               Remember to tailor your resume to the specific job you are applying for and to highlight the skills and experiences that are most relevant to that position. Good luck with your job search!</div>
        </div>
              </div>
