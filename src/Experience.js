...
<div className='Experience'>
    <div className='exp1'>
          <h2 className="col-md-1 offset-md-1">Experience:</h2>
          <h5><b className='col-md-1 offset-md-2'>Date:</b> oct-2021 oct-2022</h5>
          <div className='col-md-6 offset-md-2'>
             ...
             <ul className='exp4'>
                ...
                <li>Having good knowledge of Git and AWS.</li>
                     ...
                     sts,vs code.
              <div>You can see my work here https://github.com/muvvaladeepak</div>
          </div>
    </div>
</div>
);
